...
* FIX: Fix sr_leadcapture_recipient sanitization callback to support multiple recipients
...
* FIX: Sanitize page title text on single listing pages.

= 3.2.2 =

* FIX: Fix remaining plugin-check warnings / add form nonces
* FIX: Fix bug in [sr_map_search] when no setting filters are used
* IMPROVE: Improve pagination link scrolling in [sr_map_search]
* IMPROVE: Improve Galleria.js loading sequence and compatibility

= 3.2.1 =

* IMPROVE: Add direct access protection to all files
* IMPROVE: Use wp_safe_redirect() instead of wp_redirect()
...
* IMPROVE: Ensure compliance field keys are formatted for display correctly
